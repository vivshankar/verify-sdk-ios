...
struct ContentView: View {
    ...
    @State private var authorizationURL: String = "https://sdk.verify.ibm.com/oauth2/authorize"
    @State private var tokenURL: String = "https://sdk.verify.ibm.com/oauth2/token"
